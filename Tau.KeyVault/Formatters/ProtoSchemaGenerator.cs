...
public static class ProtoSchemaGenerator
{
    public static void Generate(string webRootPath)
    {
        ...
        var protoTypes = new[]
        {
            ...
            typeof(DeleteKeyResponse),
            typeof(AuditEntryResponse),
            typeof(AuditEntryListResponse),
            typeof(ApiKeyResponse),
            typeof(ApiKeyListResponse),
            typeof(ApiKeySecretResponse),
            typeof(RevokeApiKeyResponse),
            typeof(CreateApiKeyRequest),
            typeof(UpdateApiKeyRequest),
